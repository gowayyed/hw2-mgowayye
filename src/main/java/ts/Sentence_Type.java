...
public class Sentence_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ts.Sentence");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "ts.Sentence");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "ts.Sentence");
  ...
  public int getTokens(int addr) {
      ...
      jcas.throwFeatMissing("tokens", "ts.Sentence");
  ...
  public int getMentions(int addr) {
      ...
      jcas.throwFeatMissing("mentions", "ts.Sentence");
  ...
  /** @generated */
  final Feature casFeat_predictedGenes;
  /** @generated */
  final int     casFeatCode_predictedGenes;
  /** @generated
   * @param addr low level Feature Structure reference
   * @return the feature value 
   */ 
  public int getPredictedGenes(int addr) {
        if (featOkTst && casFeat_predictedGenes == null)
      jcas.throwFeatMissing("predictedGenes", "ts.Sentence");
    return ll_cas.ll_getRefValue(addr, casFeatCode_predictedGenes);
  }
  /** @generated
   * @param addr low level Feature Structure reference
   * @param v value to set 
   */    
  public void setPredictedGenes(int addr, int v) {
        if (featOkTst && casFeat_predictedGenes == null)
      jcas.throwFeatMissing("predictedGenes", "ts.Sentence");
    ll_cas.ll_setRefValue(addr, casFeatCode_predictedGenes, v);}
   ...
   * @return value at index i in the array 
   */
  public int getPredictedGenes(int addr, int i) {
        if (featOkTst && casFeat_predictedGenes == null)
      jcas.throwFeatMissing("predictedGenes", "ts.Sentence");
    if (lowLevelTypeChecks)
      return ll_cas.ll_getRefArrayValue(ll_cas.ll_getRefValue(addr, casFeatCode_predictedGenes), i, true);
    jcas.checkArrayBounds(ll_cas.ll_getRefValue(addr, casFeatCode_predictedGenes), i);
  return ll_cas.ll_getRefArrayValue(ll_cas.ll_getRefValue(addr, casFeatCode_predictedGenes), i);
  }
   ...
   * @param v value to set
   */ 
  public void setPredictedGenes(int addr, int i, int v) {
        if (featOkTst && casFeat_predictedGenes == null)
      jcas.throwFeatMissing("predictedGenes", "ts.Sentence");
    if (lowLevelTypeChecks)
      ll_cas.ll_setRefArrayValue(ll_cas.ll_getRefValue(addr, casFeatCode_predictedGenes), i, v, true);
    jcas.checkArrayBounds(ll_cas.ll_getRefValue(addr, casFeatCode_predictedGenes), i);
    ll_cas.ll_setRefArrayValue(ll_cas.ll_getRefValue(addr, casFeatCode_predictedGenes), i, v);
  }
  ...
  public Sentence_Type(JCas jcas, Type casType) {
    ...
    casFeat_predictedGenes = jcas.getRequiredFeatureDE(casType, "predictedGenes", "uima.cas.FSArray", featOkTst);
    casFeatCode_predictedGenes  = (null == casFeat_predictedGenes) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_predictedGenes).getCode();
