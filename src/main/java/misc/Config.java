...
public class Config {
   ...
   */
 public static String inputPath = "hw2.in";
...
//   public static String inputPath = "hw1.in";
  ...
  public static String dictionaryFilename = "gdic.txt";
}